...
class ToolButtonConfigDialog : BaseBottomSheetDialogFragment(R.layout.dialog_tool_button_config) {
    ...
    private fun getAllButtonIds(): List<String> {
        return listOf("search", "auto_page", "catalog", "read_aloud", "setting", "addBookmark", "theme", "prev_chapter", "next_chapter", "replace", "replace_badge", "speak_engine")
    }
    ...
    private fun getButtonInfo(id: String): Pair<Int, String> {
        return when (id) {
            ...
            "speak_engine" -> R.drawable.ic_tts_engine to getString(R.string.speak_engine)
