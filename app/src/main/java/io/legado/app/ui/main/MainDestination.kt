...
sealed class MainDestination(
    ...
    object ReadRecord : MainDestination(
        route = "read_record",
        labelId = R.string.read_record_nav
    )
    ...
    companion object {
        val mainDestinations = persistentListOf<MainDestination>(Home, Bookshelf, Explore, Rss, ReadRecord, My)
    }
}
...
val MainDestination.customIconPath: String
    get() = when (this) {
        ...
        MainDestination.ReadRecord -> ThemeConfig.navIconReadRecord
