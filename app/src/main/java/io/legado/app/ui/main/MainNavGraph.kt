...
import io.legado.app.ui.main.ainovelfilter.AiNovelFilterScreen
...
fun MainActivity.mainEntryProvider(
    ...
    entry<MainRouteHome> {
        MainScreen(
            ...
            onNavigateToAiNovelFilter = {
                onNavigateToRoute(MainRouteAiNovelFilter)
            },
            sharedTransitionScope = sharedTransitionScope,
