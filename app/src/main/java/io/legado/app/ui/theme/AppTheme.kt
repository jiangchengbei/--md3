...
fun AppTheme(
    ...
    AppThemeCore(darkTheme = darkTheme, useBackground = true, content = content)
}

@OptIn(ExperimentalMaterial3ExpressiveApi::class)
@Composable
fun AppThemeNoBackground(
    darkTheme: Boolean = isSystemInDarkTheme(),
    content: @Composable () -> Unit
) {
    AppThemeCore(darkTheme = darkTheme, useBackground = false, content = content)
}

@OptIn(ExperimentalMaterial3ExpressiveApi::class)
@Composable
private fun AppThemeCore(
    darkTheme: Boolean,
