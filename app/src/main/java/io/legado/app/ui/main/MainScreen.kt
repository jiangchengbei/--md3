...
fun MainScreen(
    ...
    onNavigateToAiNovelFilter: () -> Unit = {},
    ...
    LaunchedEffect(viewModel, context) {
        viewModel.effects.collect { effect ->
            when (effect) {
                ...
                MainEffect.NavigateToAiNovelFilter -> onNavigateToAiNovelFilter()
            }
        }
    }
    ...
    Row(modifier = Modifier.fillMaxSize()) {
        ...
        AppScaffold(
            ...
            Box(
                        ...
                        when (destination) {
                            ...
                            MainDestination.Bookshelf -> BookshelfScreen(
                                ...
                                onBookLongClick = { book ->
                                    onNavigateToBookInfo(book.name, book.author, book.bookUrl, book.origin, book.getDisplayCover(), null)
                                },
                            ...
                            MainDestination.ReadRecord -> ReadRecordScreen(
                                ...
                                onBookClick = { name, author ->
                                    onNavigateToBookInfo(name, author, "", null, null, null)
                                },
                                onSummaryClick = { onNavigateToReadRecordOverview() }
                            )
                            MainDestination.My -> MyScreen(
                                onOpenSettings = onOpenSettings,
                                onOpenAiNovelFilter = onNavigateToAiNovelFilter,
                                onNavigate = { event ->
                                    when (event) {
                ...
                if (ThemeConfig.showReadAloudMiniPlayer) {
                    ReadAloudMiniPlayer(
                        modifier = Modifier
                            ...
                            .padding(
                                ...
                                bottom = WindowInsets.navigationBars
                                    ...
                                    if (useFloatingBottomBar) 100.dp else 80.dp
                                } else {
                                    20.dp
                                }
                            )
