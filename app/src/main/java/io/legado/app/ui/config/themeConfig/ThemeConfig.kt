...
object ThemeConfig {
    ...
    var navIconReadRecord by prefDelegate(PreferKey.navIconReadRecord, "")

    var showReadAloudMiniPlayer by prefDelegate(PreferKey.showReadAloudMiniPlayer, true)
    var showDesktopReadAloudMiniPlayer by prefDelegate(PreferKey.showDesktopReadAloudMiniPlayer, false)
