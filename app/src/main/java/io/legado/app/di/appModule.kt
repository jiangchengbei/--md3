...
import io.legado.app.ui.main.ainovelfilter.AiNovelFilterViewModel
...
val appModule = module {
    ...
    singleOf(::HomepageModulesRepository)
    ...
    single<HomepageModulesGateway> { get<HomepageModulesRepository>() }
    ...
    viewModelOf(::AiNovelFilterViewModel)
