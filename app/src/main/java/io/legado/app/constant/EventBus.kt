...
object EventBus {
    ...
    const val READ_ALOUD_COVER_SIZE = "readAloudCoverSize"
    const val READ_ALOUD_SHOW_COVER = "readAloudShowCover"
    const val READ_ALOUD_SUBTITLE_FONT_SIZE = "readAloudSubtitleFontSize"
