...
object PreferKey {
    ...
    const val navIconReadRecord = "navIconReadRecord"
    const val showReadRecord = "showReadRecord"
    
    // AI背景音乐相关
    const val aiBgmEnabled = "ai_bgm_enabled"
    const val aiBgmDir = "ai_bgm_dir"
    const val aiBgmModelUrl = "ai_bgm_model_url"
    const val aiBgmModelName = "ai_bgm_model_name"
    const val aiBgmModelKey = "ai_bgm_model_key"
    const val aiBgmPrompts = "ai_bgm_prompts"
    const val aiBgmFrequency = "ai_bgm_frequency"
    const val aiBgmScenesPerMusic = "ai_bgm_scenes_per_music"
    const val aiBgmVolume = "ai_bgm_volume"
    
    // 朗读封面和字幕设置
    const val readAloudCoverSize = "readAloudCoverSize"
    const val readAloudShowCover = "readAloudShowCover"
    const val readAloudSubtitleFontSize = "readAloudSubtitleFontSize"
    const val readAloudCoverCarousel = "readAloudCoverCarousel"
    
    // 朗读悬浮播放器
    const val showReadAloudMiniPlayer = "showReadAloudMiniPlayer"
    const val showDesktopReadAloudMiniPlayer = "showDesktopReadAloudMiniPlayer"
}
