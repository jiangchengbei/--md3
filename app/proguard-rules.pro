...
# Koin: keep constructors for classes registered via singleOf/viewModelOf/factoryOf
-keepattributes *Annotation*
-keepattributes Signature
-keepattributes Exceptions
-keepattributes InnerClasses
-keepattributes EnclosingMethod
-keepclassmembers class io.legado.app.ui.**.*ViewModel { <init>(...); }
-keepclassmembers class io.legado.app.domain.usecase.** { <init>(...); }
-keepclassmembers class io.legado.app.data.repository.** { <init>(...); }
